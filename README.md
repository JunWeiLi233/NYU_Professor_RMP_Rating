...
npm run package:release -- v0.1.13
```
...
- Copy diagnostics copies only build, Albert content version, card count, quick-view count, cell count, trailing rating-column count, and page status.
